...
- **Home Page**: Introduction to the website and overview of swimming strokes.
- **Stroke Pages**: Dedicated pages for each swimming stroke:
  - Freestyle
  - Backstroke
  - Breaststroke
  - Butterfly
...
- `freestyle.html`: Page for freestyle stroke.
...
Since this is a static website, you can simply open `index.html` in any modern web browser to view the site. No server setup is required.
...
Feel free to contribute by adding more content, improving the design, or fixing any issues. Pull requests are welcome!
